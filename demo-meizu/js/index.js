/* 
 * cloasAd: 实现效果： 点击关闭广告按钮，获取header这个设置了绝对定位的元素
 *           然后每隔10毫秒就修改一次定位的top值，当top值为0的时候，
 *          就表明广告被完全覆盖了，然后让这个广告消失
 */
addLoadEvent(closeAd);
function closeAd() {
    // 按钮
